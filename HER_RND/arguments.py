...
def get_args():
    ...
    parser.add_argument('--action-l2', type=float, default=0.01, help='l2 reg')  # TODO
    parser.add_argument('--double-q', action='store_true')
    parser.add_argument('--critic2-ratio', type=float, default=0.1)
    parser.add_argument('--q-reward-weight', type=float, default=0.5)
    parser.add_argument('--q-explore-weight', type=float, default=0.5)

    # net config
    parser.add_argument('--actor-type', type=str, default='dense')
    parser.add_argument('--critic-type', type=str, default='pop_art')
    parser.add_argument('--curiosity-type', type=str, choices=['forward', 'rnd'], default='forward')
