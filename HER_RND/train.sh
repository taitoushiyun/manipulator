...
wait
python train.py --cuda --headless-mode --add-dtt --train --code-version block_114 --q-reward-weight 1.0 --q-explore-weight 0.0 --n-epochs 100 --goal-set block2 --eval-goal-set  block2 --scene-file mani_block2_env_6.xml --lr-critic 0.0001 &
python train.py --cuda --headless-mode --add-dtt --train --code-version block_115 --q-reward-weight 1.0 --q-explore-weight 0.0 --n-epochs 100 --goal-set block2 --eval-goal-set  block2 --scene-file mani_block2_env_6.xml --lr-critic 0.0005 &
python train.py --cuda --headless-mode --add-dtt --train --code-version block_116 --q-reward-weight 1.0 --q-explore-weight 0.0 --n-epochs 100 --goal-set block2 --eval-goal-set  block2 --scene-file mani_block2_env_6.xml --lr-critic 0.001 &
python train.py --cuda --headless-mode --add-dtt --train --code-version block_117 --q-reward-weight 1.0 --q-explore-weight 0.0 --n-epochs 100 --goal-set block2 --eval-goal-set  block2 --scene-file mani_block2_env_6.xml --lr-critic 0.005 &
python train.py --cuda --headless-mode --add-dtt --train --code-version block_118 --q-reward-weight 1.0 --q-explore-weight 0.0 --n-epochs 100 --goal-set block2 --eval-goal-set  block2 --scene-file mani_block2_env_6.xml --lr-critic 0.01 &
